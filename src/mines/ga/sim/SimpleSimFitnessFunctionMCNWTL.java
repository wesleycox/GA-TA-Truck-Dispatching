...
public abstract class SimpleSimFitnessFunctionMCNWTL {
	...
	protected int[] assignedShovel;							//current assigned shovel for each truck in simulation.
	protected int[] assignedCrusher;						//current assigned crusher for each truck in simulation.
	protected int[] assignedRoute;							//current assigned route for each truck in simulation.
	 ...
	 */
	public SimpleSimFitnessFunctionMCNWTL(int numTrucks, int numCrushers, int numShovels, int numRoads, double[] emptyTimesMean, 
	...
	public double getActivity(double runtime) {
		double active = 0;
